...
def save_iv_file():
	...
	if heat_test_taken:
		heat_file_name, heat_content_rows = write_heat_test_file(file_name, heat_current_list, heat_voltage_list, temperature_list, formatted_date, formatted_time, iv_data.get("n", ""), iv_data.get("is", ""))
